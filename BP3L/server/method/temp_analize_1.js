...
Meteor.methods({
    ...
    'temp_analize_1': (testId)=> {
        ...
        tests.forEach(function (item, index, arr) {
            ...
            if (test.testType == "DiscoverAndConnectAndMeasureTest") {
                ...
                //第一次发现
                test.discover_1__count = DB.SLDtest.find({
                    testId: item.testId,
                ...
                test.discover_1_count_success = test.discover_1__count -test.discover_1_count_failure


                //第二次发现
                test.discover_2__count = DB.SLDtest.find({
                    testId: item.testId,
                ...
                test.discover_2_count_success = test.discover_2__count -test.discover_2_count_failure
